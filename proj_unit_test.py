...
class TestSum(unittest.TestCase):
    def test_no_steal_normal_turn(self):
        ...
        self.assertEqual(result_of_taking_turn, [[4,4,4,0,5,5],1,[4,4,4,4,4,5],0,False], "did not have a right turn")
    ...
    def test_no_steal_whole_board(self):
        ...
        slot=6
        result_of_taking_turn=a.take_turn(my_side,opponent_side,my_score,opponent_score,slot)        
        self.assertEqual(result_of_taking_turn, [[5,5,4,4,4,0],1,[5,5,5,5,5,5],0,False], "did not have a right turn")
    ...
    def test_no_steal_next_turn(self):
        ...
        slot=6
        result_of_taking_turn=a.take_turn(my_side,opponent_side,my_score,opponent_score,slot)        
        self.assertEqual(result_of_taking_turn, [[4,4,4,4,4,0],1,[4,4,4,4,4,4],0,True], "did not have a right turn")
    ...
    def test_no_steal_next_turn_whole_board(self):
        ...
        slot=6
        result_of_taking_turn=a.take_turn(my_side,opponent_side,my_score,opponent_score,slot)        
        self.assertEqual(result_of_taking_turn, [[5,5,5,5,5,1],2,[5,5,5,5,5,5],0,True], "did not have a right turn")
    ...
    def test_stealing(self):        
        ...
        slot=5
        result_of_taking_turn=a.take_turn(my_side,opponent_side,my_score,opponent_score,slot)        
        self.assertEqual(result_of_taking_turn, [[4,4,4,4,0,0],5,[4,4,4,4,4,0],0,False], "did not have a right turn")
